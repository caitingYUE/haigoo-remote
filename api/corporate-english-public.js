...
function getPermissions(user, companyAccessTier = 'vip') {
  ...
  return {
    ...
    canViewProfile: isFreeCompany || capabilities.canAccessCorporateEnglishProfile,
    canViewClips: capabilities.canAccessCorporateEnglishClips,
    canViewResources: isFreeCompany || capabilities.canAccessCorporateEnglishResources,
