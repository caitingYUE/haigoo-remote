...
import { ThumbsUp, ArrowRight, ShieldCheck } from 'lucide-react';
    ...
    return (
        ...
        >
            ...
            <div className="absolute top-0 right-0 p-2 opacity-10 group-hover:opacity-20 transition-opacity pointer-events-none">
                <ThumbsUp className="w-24 h-24 text-violet-600 -rotate-12 translate-x-4 -translate-y-4" />
            </div>
                ...
                <div className="flex-1 min-w-0 flex flex-col justify-between">
                    <div>
                        <div className="flex items-center gap-2 mb-1">
                            <h4 className="font-bold text-slate-900 text-base">可信企业提名</h4>
                            <span className="px-2 py-0.5 bg-white/60 text-violet-700 text-xs font-bold rounded-full border border-violet-100 whitespace-nowrap">Co-build</span>
                        </div>
                        
                        <p className="text-sm text-slate-600 leading-relaxed mb-2">
                            发现优质远程企业？提供企业官网和联系方式，共建可信远程生态。
                        </p>
                    </div>

                    <div className="flex items-center text-xs text-violet-600 font-bold group-hover:translate-x-1 transition-transform mt-auto">
                        立即提名 <ArrowRight className="w-3 h-3 ml-1" />
                    </div>
                </div>
            </div>
        </div>
