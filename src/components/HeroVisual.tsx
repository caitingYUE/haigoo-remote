  ...
  return (
    <section className="container-fluid mt-6 mb-8">
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-orange-100 via-[#eff5fb] to-emerald-50 p-6 border border-slate-200">
        ...
        <div className="space-y-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            ...
            <div className="rounded-2xl border p-5 bg-white">
              <div className="flex items-center gap-3">
                <span className="inline-flex items-center justify-center h-10 w-10 rounded-xl bg-[#dce9f5] text-[#466f9d]"><Bot className="w-5 h-5" /></span>
                <div>
