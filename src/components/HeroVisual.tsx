  ...
  return (
    <section className="container-fluid mt-6 mb-8">
      <div className="mx-auto max-w-7xl grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
        ...
        <div className="rounded-3xl bg-gradient-to-br from-orange-100 via-indigo-50 to-emerald-50 p-6 border border-gray-200">
          <div className="h-40 md:h-56 rounded-2xl bg-white/60 border border-white/80" />
          <h2 className="mt-6 text-2xl md:text-3xl font-bold text-gray-900">Work your brain, leave your body to be happy</h2>
          <p className="mt-2 text-gray-600">Open to the world · Remote jobs · Global opportunities</p>
        </div>

        {/* 右侧搜索与CTA */}
        <div className="space-y-4">
          <div className="flex w-full overflow-hidden rounded-2xl border border-gray-200 bg-white">
