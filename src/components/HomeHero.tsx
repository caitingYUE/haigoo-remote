            ...
            <div className="relative z-10 w-full max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
                <div className="flex flex-col lg:flex-row items-center gap-12 lg:gap-16">
                    ...
                    <div className="flex-1 text-center lg:text-left">
                        {/* Badge */}
                        <div className={`inline-flex items-center gap-2 px-3 py-1.5 rounded-full ${isChristmas ? 'bg-red-50 border-red-100' : 'bg-indigo-50 border-indigo-100'} border mb-8 animate-in fade-in slide-in-from-bottom-4 duration-700 shadow-sm mx-auto lg:mx-0`}>
                        ...
                        {/* Subtitle */}
                        <p className="text-lg md:text-xl text-slate-600 max-w-2xl mx-auto lg:mx-0 mb-10 leading-relaxed font-normal animate-in fade-in slide-in-from-bottom-6 duration-700 delay-200">
                            连接全球顶尖远程企业，消除信息不对称。不论身在国内还是海外，
                            <br className="hidden md:block" />让我们助你找到理想的 Work-Life Balance。
                        </p>

                        {/* Search Bar */}
                        <div className="w-full max-w-xl mx-auto lg:mx-0 mb-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-300">
                        ...
                        {/* Stats */}
                        <div className="flex flex-wrap justify-center lg:justify-start gap-8 md:gap-12 animate-in fade-in slide-in-from-bottom-8 duration-700 delay-400">
                    ...
                    {/* Right Content - Daily Humor Card */}
                    <div className="hidden lg:block w-full max-w-[340px] shrink-0 animate-in fade-in slide-in-from-right-8 duration-1000 delay-300">
                        <div className="relative group">
                            {/* Card Glow Effect */}
                            <div className="absolute -inset-0.5 bg-gradient-to-br from-red-200 via-amber-100 to-red-200 rounded-3xl opacity-70 group-hover:opacity-100 blur transition duration-500"></div>
                            
                            {/* Card Content */}
                            <div className="relative bg-white rounded-[1.5rem] p-6 shadow-[0_8px_30px_rgb(0,0,0,0.04)] border border-slate-50 flex flex-col h-full min-h-[320px]">
                                {/* Header: Date */}
                                <div className="flex items-center justify-between mb-6 border-b border-slate-100 pb-4">
                                    <div className="flex items-center gap-2 text-slate-500">
                                        <Calendar className="w-4 h-4 text-red-400" />
                                        <span className="text-sm font-medium tracking-wide">{todayDateStr}</span>
                                    </div>
                                    <div className="px-2 py-1 bg-red-50 text-red-600 text-xs font-bold rounded-lg">
                                        每日一签
                                    </div>
                                </div>
                                ...
                                <div className="flex-1 flex flex-col justify-center mb-6">
                                    <Quote className="w-8 h-8 text-amber-200 mb-4 opacity-50" />
                                    <p className="text-lg text-slate-700 font-medium leading-relaxed tracking-wide italic">
                                ...
                                <div className="flex items-center justify-end gap-3">
                                    <div className="text-right">
                                        ...
                                        <p className="text-sm font-bold text-slate-900">{dailyCard?.author || 'Haigoo 搞钱小分队'}</p>
                                    </div>
                                    <div className="w-10 h-10 bg-gradient-to-br from-amber-100 to-red-50 rounded-full flex items-center justify-center text-xl shadow-inner">
                                        🧧
                                    </div>
                                </div>
                            </div>
