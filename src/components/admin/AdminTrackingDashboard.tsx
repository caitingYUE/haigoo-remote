    ...
    return (
        <div className="space-y-6">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                ...
                {/* 4. Trend Chart */}
                <div className="bg-white p-6 rounded-xl border border-slate-200 shadow-sm flex flex-col text-sm">
                    <h3 className="font-bold text-slate-800 mb-4 flex items-center">
                    ...
                    <div className="flex-1 w-full min-h-[250px] relative">
                        {!data?.trend || data.trend.length === 0 ? (
                            <div className="absolute inset-0 flex items-center justify-center text-slate-400">暂无数据</div>
                        ) : (
                            <ResponsiveContainer width="100%" height="100%">
                                <LineChart data={data.trend} margin={{ top: 10, right: 10, left: -25, bottom: 0 }}>
                                    ...
                                    <Tooltip
                                        ...
                                        formatter={(value: any, name: any) => [value, name === 'uv' ? 'UV (访客)' : 'PV (浏览)']}
