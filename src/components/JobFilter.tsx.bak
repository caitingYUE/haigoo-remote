      ...
      <div className="p-6">
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-slate-700 mb-3">
            <Search className="w-4 h-4 inline mr-2 text-indigo-500" />
            搜索关键词
          </label>
          <div className="relative">
            <input
              ...
              className="w-full pl-10 pr-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-slate-50 hover:bg-white"
            />
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-slate-700 mb-3">
            <Briefcase className="w-4 h-4 inline mr-2 text-indigo-500" />
            工作类型
          </label>
                ...
                <button
                  ...
                  className={`p-3 rounded-xl text-sm font-medium transition-all duration-200 border-2 ${
                    isSelected
                      ...
                      : 'bg-slate-50 text-slate-700 border-slate-200 hover:bg-indigo-50 hover:border-indigo-300 hover:text-indigo-600'
                  }`}
                >
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-slate-700 mb-3">
            <DollarSign className="w-4 h-4 inline mr-2 text-indigo-500" />
            薪资范围 (USD)
          </label>
          <div className="grid grid-cols-2 gap-3">
            <div className="relative">
              <input
                ...
                placeholder="最低薪资"
                className="w-full pl-8 pr-4 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-slate-50 hover:bg-white text-sm"
                min="0"
                step="1000"
              />
        ...
        <div className="mb-6">
          <label className="block text-sm font-medium text-slate-700 mb-3">
            <span className="inline-flex items-center">
              <span className="w-4 h-4 bg-gradient-to-br from-green-400 to-indigo-500 rounded mr-2 flex items-center justify-center">
          ...
          <div className="relative mb-4">
            <input
              ...
              className="w-full pl-4 pr-12 py-3 border border-slate-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:border-transparent transition-all duration-200 bg-slate-50 hover:bg-white text-sm"
            />
            {skillInput && (
              <button
                onClick={() => handleSkillAdd(skillInput.trim())}
                className="absolute right-3 top-1/2 transform -translate-y-1/2 w-6 h-6 bg-indigo-500 text-white rounded-lg hover:bg-indigo-600 transition-colors flex items-center justify-center"
              >
                  ...
                  <button
                    ...
                    className={`px-3 py-1.5 text-xs font-medium rounded-lg transition-all duration-200 ${
                      isSelected
                        ...
                        : 'bg-indigo-50 text-indigo-600 hover:bg-indigo-100 hover:text-indigo-700 border border-indigo-200 hover:border-indigo-300'
                    }`}
                  >
                    {skill}
                  </button>
            ...
            <div className="bg-gradient-to-r from-indigo-50 to-purple-50 rounded-xl p-4 border border-indigo-100">
              ...
              <div className="flex flex-wrap gap-2">
                {filters.skills.map((skill) => (
                  <span
                    key={skill}
                    className="inline-flex items-center px-3 py-1.5 bg-gradient-to-r from-indigo-500 to-purple-600 text-white text-xs font-medium rounded-lg shadow-sm"
                  >
                    {skill}
                    <button
        ...
        <div className="lg:hidden">
          <button
            ...
            className="w-full px-4 py-3 bg-gradient-to-r from-indigo-500 to-purple-600 text-white rounded-xl font-medium flex items-center justify-center hover:from-indigo-600 hover:to-purple-700 transition-all duration-200"
          >
