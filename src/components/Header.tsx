...
export default function Header() {
  ...
  return (
    <header
      ...
      role="banner"
    >
      <div className="w-full mx-auto px-4 sm:px-6 lg:px-8 pointer-events-auto transition-all duration-300 bg-white/50 backdrop-blur-md border-b border-white/40">
