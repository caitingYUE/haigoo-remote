  ...
  async getProcessedJobs(
    ...
    try {
      ...
      const jobs: Job[] = data.jobs.map((job: any) => ({
        ...
        algorithmVersion: job.algorithmVersion || job.algorithm_version || undefined,
        calibrationVersion: job.calibrationVersion || job.calibration_version || undefined,
        constraintFlags: job.constraintFlags || job.constraint_flags || null,
