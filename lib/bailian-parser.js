...
6. chinaFriendly: Boolean (true/false).
   - Return true if:
     - Job explicitly mentions "China", "Asia", "APAC", "Global", "Anywhere", "Worldwide".
     - Timezone includes GMT+8, UTC+8, CST (China Standard Time).
     - Timezone overlap is flexible enough for China (e.g. asynchronous, or overlap with Europe/morning US).
   - Return false if:
     - Job requires "US Only", "North America Only", "EU Only".
     - Timezone is strictly US/Americas (e.g. "PST only", "EST only") without flexibility.
