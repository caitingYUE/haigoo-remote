...
const KEYWORD_DICTIONARY = {
  ...
  'data': ['数据'],
  '人事行政': ['hr', 'human resources', 'people operations', 'recruiter', 'talent acquisition', 'admin', 'operations', 'finance', 'legal', 'customer support'],
  'hr': ['人力资源', '招聘', '人才招聘', '人事行政', 'people operations', 'human resources', 'recruiter', 'talent acquisition'],
  '人力资源': ['hr', 'human resources', 'people operations', 'recruiter', 'talent acquisition'],
  '招聘': ['recruiter', 'recruiting', 'talent acquisition', 'sourcer', 'hr'],
  '财务': ['finance', 'accounting', 'accountant', 'controller', 'payroll'],
  '会计': ['accounting', 'accountant', 'finance', 'bookkeeper'],
  '法务': ['legal', 'counsel', 'law', 'compliance'],
  '行政': ['admin', 'administration', 'operations', 'office manager'],
  '客户服务': ['customer support', 'customer success', 'support specialist', 'client support'],
  '运营': ['operations', 'ops', 'operation', 'program manager', 'project manager'],
  '市场': ['marketing', 'growth', 'content', 'social media', 'digital marketing'],
  '营销': ['marketing', 'growth', 'content marketing', 'digital marketing'],
  '销售': ['sales', 'account executive', 'business development', 'bd', 'customer success'],
  '商务': ['business development', 'bd', 'sales', 'partnerships', 'account manager'],
  '客服': ['customer support', 'customer service', 'support specialist', 'customer success'],
  '项目经理': ['project manager', 'program manager', 'pm', 'project management'],
  '自由职业': ['freelance', 'freelancer', 'contractor', 'contract', 'part-time', 'part time', '兼职', '合同工'],
  'freelance': ['自由职业', 'freelancer', 'contractor', 'contract', 'part-time', '兼职'],
  'freelancer': ['自由职业', 'freelance', 'contractor', 'contract'],
  '兼职': ['part-time', 'part time', 'freelance', '自由职业'],
  'part-time': ['兼职', 'part time', 'freelance', '自由职业'],
  'part time': ['兼职', 'part-time', 'freelance', '自由职业'],
  '合同工': ['contract', 'contractor', 'contract role', 'freelance'],
  'contract': ['合同工', 'contractor', 'freelance', '固定期限'],
  'contractor': ['合同工', 'contract', 'freelance'],
  '入门': ['entry level', 'junior', '初级', 'intern', 'internship'],
  '初级': ['junior', 'entry level', '入门'],
  '中级': ['mid-level', 'intermediate', 'mid level'],
  '高级': ['senior', 'staff', 'lead', 'principal'],
  '主管': ['manager', 'lead', 'head', 'director'],
  '经理': ['manager', 'lead', 'head'],
  '实习': ['intern', 'internship', '实习生'],
  'intern': ['实习', '实习生', 'internship'],
  'senior': ['高级', '资深'],
  'junior': ['初级', '入门'],
  ...
  'remote': ['远程', '在家办公'],
  '全球': ['global', 'worldwide', 'anywhere', 'remote'],
  'global': ['全球', 'worldwide', 'remote'],
  '亚太': ['apac', 'asia pacific', 'asia', 'remote'],
  'apac': ['亚太', 'asia pacific', '亚洲'],
  '中国': ['china', 'cn', 'mainland china', 'remote china'],
  'china': ['中国', '国内远程'],
  ...
  'web3': ['区块链', '加密货币'],
  '人工智能': ['ai', 'artificial intelligence', 'machine learning', 'ml'],
  'ai': ['人工智能', 'machine learning', 'ml', '算法'],
  'saas': ['软件服务', 'b2b software', 'enterprise software'],
  '教育': ['education', 'edtech', 'learning'],
  '医疗': ['healthcare', 'health tech', 'medical'],
  '旅游': ['travel', 'hospitality']
};
 ...
 */
export function expandSearchTerms(query, options = {}) {
  ...
  if (includeTokens && tokens.length > 1) {
