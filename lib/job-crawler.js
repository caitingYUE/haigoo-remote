...
export async function crawlCompanyJobs(companyId, companyName, careersUrl, options = {}) {
    ...
    // Only apply if NOT using Greenhouse URL (user might want to use Greenhouse directly)
    if ((companyName === 'Fueled' || careersUrl.includes('fueled.com')) && !careersUrl.includes('greenhouse.io')) {
