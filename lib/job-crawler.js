                    ...
                    if (appDataMatch) {
                        try {
                            ...
                            if (appData.jobBoard && appData.jobBoard.jobPostings) {
                                ...
                                // Fallback for single job page or different structure?
                                // Actually, for the main board, it should be jobBoard.
                                // If it's empty, maybe it's using 'posting' key?
                                // Wait, the diagnose script showed 'posting' key on DETAIL page.
                                // But on LIST page, it should be jobBoard.jobPostings.
                                // Let's check if the list page structure is different for Chainlink.
                            }
                        } catch (parseErr) {
