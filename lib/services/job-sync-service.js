...
import { reconcileCompanyDirectoryHistory } from './mini-company-match-service.js';
...
export async function syncCompanyJobs(companyId, companyName, crawledJobs) {
    ...
    if (toUpsert.length > 0) {
        ...
        // Public opportunity transitions are captured atomically by the database.
    } else if (idsToDeactivate.length > 0) {
