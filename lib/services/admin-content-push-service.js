...
function buildLocalCompanySummary(company = {}, maxLength = 58) {
...
export async function generateXiaohongshuSummary(payload = {}) {
  ...
  const localSummary = buildLocalSummary(job, 140)
  const localCompanySummary = buildLocalCompanySummary({ description: job.companyDescription }, 58)
  const cacheKey = [
