...
{
  "growth_stages": [
    {"year": "String (e.g. 2015-2018)", "keyword": "String (e.g. Learning)"},
    {"year": "String (e.g. 2019-2021)", "keyword": "String (e.g. Growth)"},
    {"year": "String (e.g. 2022-Present)", "keyword": "String (e.g. Leadership)"}
  ],
...
3. Tone: Healing, non-judgmental, metaphorical.
4. Be creative based on the keywords.
`;
