...
Task:
1. Identify 3-4 key growth stages (e.g. School, Junior, Senior, Lead).
2. For EACH stage, pick ONE core keyword (English) that represents that phase best.
3. If the provided keywords are sparse, INFERS and EXPANDS with positive personality traits and professional strengths (e.g. "Resilience", "Empathy", "Visionary") to ensure the tree is lush.
4. Generate a healing interpretation.

Output: A STRICT JSON object (no markdown) with this structure:
{
  "growth_stages": [
    {"label": "String (e.g. Stage 1)", "keyword": "String (e.g. Learning)"},
    {"label": "String (e.g. Stage 2)", "keyword": "String (e.g. Growth)"},
    {"label": "String (e.g. Stage 3)", "keyword": "String (e.g. Leadership)"}
  ],
...
5. Tone: Healing, non-judgmental, metaphorical.
6. Be creative: If keywords are boring, use the expanded traits to make it special.
`;
