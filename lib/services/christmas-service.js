...
3. Generate a HIGHLY PERSONALIZED, EMOTIONAL, and POETIC interpretation based on the specific keywords provided.
   - Do NOT use generic templates like "This is a tree rooting down...".
   - Look at the specific skills (e.g. Java, Design, Marketing) to deduce the person's unique "flavor" (e.g. Rational Logic, Artistic Soul, Connector).
   - If keywords are technical, describe the beauty of logic and structure.
   - If keywords are creative, describe the colors and imagination.
   - If keywords are leadership/management, describe the strength of support and vision.
...
Output: A STRICT JSON object (no markdown) with this structure:
{
  ...
  "personality": "String (1 sentence, deeply personalized metaphor about this specific tree's character)",
  "uniqueness": "String (1 sentence, highlighting a specific unique combination of traits found in the keywords)",
  "future_wish": "String (1 sentence, a warm, specific wish related to their field)"
}

Rules:
1. Output in CHINESE (Simplified) for interpretation fields.
2. Keywords in growth_stages must be English.
3. ABSOLUTELY NO NUMBERS, DATES, YEARS, PHONE NUMBERS, OR EMAILS in any field.
4. Growth stage labels must be abstract (e.g., "Seed", "Sprout", "Bloom", "Harvest") or generic ("Start", "Rise", "Peak"), NOT years (e.g. "2023").
