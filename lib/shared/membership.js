...
export function calculateMembershipWindow(user, durationDays, now = new Date()) {
  ...
  const startAt = currentExpireDate && currentExpireDate > nowDate ? currentExpireDate : nowDate
