...
export const DEFAULT_MEMBERSHIP_PLAN_CONFIG = {
  ...
  [MEMBER_TYPES.QUARTER_PRO]: {
    ...
    discountLabel: '长期支持',
    description: '从外企英语到企业文化到远程求职，一次拿下。',
    features: [
      '包含季度会员所有权益',
      '外企英语全部视频、文化与 CEO 商业思维',
      '外企英语全部跟读音频片段',
      '更多企业资料',
      '跟读音频收藏&下载功能',
      '企业CEO联系方式'
...
export function getLegacyMembershipLevel(memberType) {
  ...
  if ([MEMBER_TYPES.TRIAL_WEEK, MEMBER_TYPES.QUARTER, MEMBER_TYPES.HALF_YEAR].includes(normalizedType)) return 'club_go'
  return 'none'
}
