  ...
  if (queryParams.industry) {
    ...
    for (const ind of industries) {
      ...
      if (ind === '人工智能') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['AI', 'Artificial Intelligence', 'Machine Learning', 'Deep Learning', 'NLP', 'LLM', 'GenAI', 'Computer Vision', '人工智能', '深度学习', '机器学习']`);
      }
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Web3', 'Blockchain', 'Crypto', 'NFT', 'DeFi', 'DAO', 'Smart Contract', 'Solidity', '区块链', '加密货币']`);
      }
      else if (ind === '互联网/软件') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Software', 'Internet', 'Technology', 'IT', 'SaaS', 'Mobile', 'App', 'Web', '互联网', '软件', '移动互联网']`);
      }
        ...
        indChecks.push(`tags ?| ARRAY['Fintech', 'Finance', 'Banking', 'Investment', 'Trading', 'Insurance', '金融', '银行', '投资', '保险', '支付']`);
      }
      else if (ind === '电子商务') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['E-commerce', 'Retail', 'DTC', 'Shopify', 'Amazon', '电商', '零售', '跨境电商']`);
      }
      else if (ind === '游戏') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Game', 'Gaming', 'Esports', 'Unity', 'Unreal', 'Mobile Game', '游戏', '电竞', '手游']`);
      }
      else if (ind === '媒体/娱乐') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Media', 'Entertainment', 'Streaming', 'Social Media', 'Content', 'Video', '媒体', '娱乐', '直播', '内容', '社交媒体']`);
      }
      else if (ind === '消费生活') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Consumer', 'Lifestyle', 'Travel', 'Food', 'Beverage', 'Hospitality', 'Fashion', '消费', '生活', '旅游', '餐饮', '时尚']`);
      }
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Enterprise', 'SaaS', 'B2B', 'Business Services', 'Cloud', '企业服务', '云服务']`);
      }
      else if (ind === '硬件/物联网') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Hardware', 'IoT', 'Semiconductor', 'Electronics', 'Robotics', 'Manufacturing', '硬件', '物联网', '半导体', '电子', '机器人']`);
      }
      else if (ind === '大健康/医疗') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Health', 'Medical', 'Biotech', 'Pharma', 'Life Sciences', 'Healthcare', '医疗', '健康', '生物', '制药']`);
      }
      else if (ind === '教育') {
        ...
        // Tag matching
        indChecks.push(`tags ?| ARRAY['Education', 'EdTech', 'Training', 'E-learning', '教育', '培训', '在线教育']`);
      }
    }
