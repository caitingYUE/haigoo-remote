  ...
  */
  ...
  if (typeof queryParams.isTranslated !== 'undefined') {
    ...
    if (boolVal) {
      ...
      // When querying for untranslated (false), also include "fake" translated ones (empty/null translations)
      conditions.push(`(is_translated IS NOT TRUE OR (is_translated IS TRUE AND (translations IS NULL OR translations::text = 'null' OR translations::text = '{}')))`)
    }
  }
