  ...
  */
  ...
  if (typeof queryParams.isTranslated !== 'undefined') {
    ...
    if (boolVal) {
      ...
      //    - AND Description has LESS THAN 10 Chinese characters (ignores "Trace Chinese" like location names)
      conditions.push(`(
        ...
        OR (
          is_translated IS TRUE AND (
            ...
            OR (
              ...
              AND
              length(regexp_replace(COALESCE(translations->>'description', ''), E'[^\\\\u4e00-\\u9fa5]', '', 'g')) < 50
            )
          )
        )
      )`)
