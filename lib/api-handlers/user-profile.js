        ...
        if (NEON_CONFIGURED) {
          const query = `
                    SELECT 
                        ...
                        j.responsibilities as "jobResponsibilities",
          ...
          const applications = result ? result.map(row => ({
            ...
            job: {
              ...
              responsibilities: typeof row.jobResponsibilities === 'string' ? JSON.parse(row.jobResponsibilities || '[]') : (row.jobResponsibilities || []),
