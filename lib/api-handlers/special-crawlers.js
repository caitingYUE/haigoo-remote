...
function isJobAllowedForChina(title, location) {
        ...
        while (nextUrl && pageCount < MAX_PAGES) {
            ...
            try {
                ...
                for (const job of results) {
                    ...
                    if (!isJobAllowedForChina(title, locationStr)) {
                        console.log(`[SpecialCrawler] Filtered out restricted job: ${title} (${locationStr})`)
                        continue
                    }
                    ...
                    if (locationStr.length > 190) {
                        locationStr = locationStr.substring(0, 190) + '...'
                    }
