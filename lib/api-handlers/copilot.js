...
当前请求：${intent === 'sprint' ? '强化 2 周冲刺投递节奏' : '生成完整投递推进方案'}
...
- 远程适配结论：${readinessLevel} ${readiness}
- 推荐岗位：
${recommendations || '暂无'}${question}

当前请求：${intent === 'mock-answer' ? '生成该问题的模拟回答与优化建议' : intent === 'more-questions' ? '生成更多高频问题' : '生成完整面试准备方案'}
