  ...
  "milestones": [
    {
      ...
      "tasks": ["<深度打磨后的行动1>", "<行动2>", ...]
        ...
        const memberOnlyActions = ['update-progress', 'align-resume', 'interview-prep', 'mock-interview', 'expand-module', 'generate-interview-plan', 'generate-answer'];
        ...
        try {
          ...
          switch (action) {
            ...
            case 'match-jobs':
              ...
              break;
            case 'hero-recommend':
              result = await handleHeroRecommendations(userId, req.body);
              break;
            case 'create-plan':
