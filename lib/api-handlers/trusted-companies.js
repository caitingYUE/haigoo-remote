...
export async function getCompaniesPaginated({ page = 1, limit = 20, sortBy = 'updated_at', sortOrder = 'desc', industry, search, name, canRefer, isTrusted }) {
    try {
        if (NEON_CONFIGURED) {
            ...
            const trustedFields = `company_id, name, website, careers_page, linkedin, description, logo, cover_image, address, employee_count, hiring_email, email_type, founded_year, specialties, company_rating, rating_source, industry, tags, source, job_count, can_refer, last_crawled_at, translations, created_at, updated_at`

            const extractedFields = `company_id, name, url as website, NULL as careers_page, NULL as linkedin, description, logo, cover_image, NULL as address, NULL as employee_count, NULL as hiring_email, NULL as email_type, NULL as founded_year, NULL as specialties, NULL as company_rating, NULL as rating_source, industry, tags, source, job_count, false as can_refer, NULL as last_crawled_at, NULL as translations, created_at, updated_at`
