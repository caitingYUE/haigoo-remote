                    ...
                    if (NEON_CONFIGURED) {
                        try {
                            ...
                            await neonHelper.transaction(async (client) => {
                                await client.query(`
                                    INSERT INTO trusted_companies 
                                    (company_id, name, website, careers_page, linkedin, description, logo, cover_image, industry, tags, source, job_count, can_refer, status, translations, updated_at, address, employee_count, hiring_email, founded_year, specialties, company_rating, rating_source)
