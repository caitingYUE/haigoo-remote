...
export default async function handler(req, res) {
    ...
    try {
        ...
        if (req.method === 'GET') {
            ...
            console.log(`[trusted-companies] GET request. Resource: ${resource}, Action: ${action}`)

            // Default GET: Return all trusted companies if no resource specified
            if (!resource && !req.query.action) {
            ...
            if (resource === 'companies') {
                ...
                // Extract companies from jobs (works with any resource or no resource)
                if (action === 'extract') {
        ...
        if (req.method === 'POST') {
            ...
            console.log(`[trusted-companies] POST request received. Action: ${action}, Resource: ${resource}`)
