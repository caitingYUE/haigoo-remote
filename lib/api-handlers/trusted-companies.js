    ...
    await neonHelper.transaction(async (client) => {
        ...
        for (const company of companies) {
            ...
            await client.query(`
                ...
                (company_id, name, website, careers_page, linkedin, description, logo, cover_image, industry, tags, source, job_count, can_refer, status, translations, created_at, updated_at, last_crawled_at, address, employee_count, hiring_email, email_type, founded_year, specialties, company_rating, rating_source)
                ...
                if (body.isTrusted) {
                    if (NEON_CONFIGURED) {
                        try {
                            ...
                            await neonHelper.transaction(async (client) => {
                                const emailTypeConstraintMode = await getEmailTypeConstraintMode(client)
                                const normalizedEmailType = normalizeEmailTypeForDb(body.emailType, emailTypeConstraintMode)

                                await client.query(`
                                    INSERT INTO trusted_companies 
                                    (company_id, name, website, careers_page, linkedin, description, logo, cover_image, industry, tags, source, job_count, can_refer, status, translations, updated_at, address, employee_count, hiring_email, email_type, founded_year, specialties, company_rating, rating_source, created_at)
                            ...
                            const savedCompany = {
                                ...
                                hiringEmail: body.hiringEmail || null,
