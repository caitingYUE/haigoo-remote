        ...
        if (req.method === 'GET') {
            ...
            if (resource === 'companies') {
                ...
                if (action === 'extract') {
                    ...
                    try {
                        // Auto-migration: Ensure extracted_companies table exists
                        try {
                            ...
                            console.error('[companies] Auto-migration failed:', e);
                        }
                ...
                if (NEON_CONFIGURED) {
                    try {
                        // Auto-migration: Ensure extracted_companies table exists
                        // We do this check once per request for safety now, can be optimized later
                        try {
                            await neonHelper.query(`
                                CREATE TABLE IF NOT EXISTS extracted_companies (
                                  id SERIAL PRIMARY KEY,
                            ...
                            console.error('[trusted-companies] Auto-migration failed:', e);
                        }
            ...
            if (action === 'aggregate-companies') {
                ...
                try {
                    ...
                    try {
                        ...
                        console.error('[aggregate-companies] Auto-migration failed:', e);
                    }
