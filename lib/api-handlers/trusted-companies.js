                        ...
                        if (company) {
                            ...
                            if (needsUpdate) {
                                ...
                                return {
                                    ...
                                    // FIX: Do NOT merge company tags into job tags (prevents data corruption)
                                    // tags: Array.from(new Set([...(job.tags || []), ...(company.tags || [])])),
                                    tags: job.tags, 
                                    companyTags: company.tags || [], // Store company tags in dedicated column
                                    isTrusted: true,
                        ...
                        await neonHelper.transaction(async (client) => {
                            for (const job of enrichedJobs) {
                                ...
                                `, [
                                    ...
                                    // Removed tags update to prevent overwriting
                                    job.isTrusted || false,
                                    job.canRefer || false,
