...
function normalizeReferralContactsForDb(referralContacts, fallbackHiringEmail, fallbackEmailType, mode = 'modern') {
    ...
    const normalized = parsed
        .map((item) => {
            ...
            return { hiringEmail, emailType, name, title, linkedin }
        })
...
function normalizeReferralContactsForClient(referralContacts, fallbackHiringEmail, fallbackEmailType) {
    const parsed = parseReferralContacts(referralContacts)
    const normalized = parsed
        .map((item) => {
            const hiringEmail = String(item?.hiringEmail || item?.email || '').trim()
        ...
        if (NEON_CONFIGURED) {
            ...
            if (result) {
                ...
                return result.map(row => ({
                    ...
                    referralContacts: normalizeReferralContactsForClient(row.referral_contacts, row.hiring_email, row.email_type),
                    ...
                    if (NEON_CONFIGURED) {
                        try {
                            ...
                            const savedCompany = {
                                ...
                                referralContacts: normalizeReferralContactsForClient(normalizedReferralContacts, normalizedHiringEmail, normalizedEmailTypeForClient),
            ...
            if (id) {
                ...
                companyToSave = {
                    ...
                    referralContacts: body.referralContacts !== undefined
                        ? normalizeReferralContactsForClient(body.referralContacts, body.hiringEmail, body.emailType)
                        : normalizeReferralContactsForClient(existing.referral_contacts, existing.hiring_email, existing.email_type),
                ...
                companyToSave = {
                    ...
                    referralContacts: normalizeReferralContactsForClient(body.referralContacts, body.hiringEmail, body.emailType),
