...
export default async function handler(req, res) {
  ...
  try {
    ...
    const corporateEnglishFunnel = computeStepMetrics([
      ...
      { stepId: 'corporate_english_ceo_module_view', label: 'CEO访谈模块 UV', uv: toInt(corporateEnglishMap.corporate_english_ceo_module_view?.uv), pv: toInt(corporateEnglishMap.corporate_english_ceo_module_view?.pv) },
      { stepId: 'corporate_english_ceo_detail_view', label: 'CEO访谈详情访问', uv: toInt(corporateEnglishMap.corporate_english_ceo_detail_view?.uv), pv: toInt(corporateEnglishMap.corporate_english_ceo_detail_view?.pv) },
      { stepId: 'corporate_english_ceo_video_play', label: 'CEO访谈播放', uv: toInt(corporateEnglishMap.corporate_english_ceo_video_play?.uv), pv: toInt(corporateEnglishMap.corporate_english_ceo_video_play?.pv) },
      { stepId: 'corporate_english_ceo_clip_play', label: 'CEO跟读播放', uv: toInt(corporateEnglishMap.corporate_english_ceo_clip_play?.uv), pv: toInt(corporateEnglishMap.corporate_english_ceo_clip_play?.pv) },
      { stepId: 'corporate_english_interview_module_view', label: '英语面试模块 UV', uv: toInt(corporateEnglishMap.corporate_english_interview_module_view?.uv), pv: toInt(corporateEnglishMap.corporate_english_interview_module_view?.pv) },
      { stepId: 'corporate_english_interview_detail_view', label: '英语面试详情访问', uv: toInt(corporateEnglishMap.corporate_english_interview_detail_view?.uv), pv: toInt(corporateEnglishMap.corporate_english_interview_detail_view?.pv) },
      { stepId: 'corporate_english_interview_video_play', label: '英语面试播放', uv: toInt(corporateEnglishMap.corporate_english_interview_video_play?.uv), pv: toInt(corporateEnglishMap.corporate_english_interview_video_play?.pv) },
      { stepId: 'corporate_english_meeting_module_view', label: '外企会议模块 UV', uv: toInt(corporateEnglishMap.corporate_english_meeting_module_view?.uv), pv: toInt(corporateEnglishMap.corporate_english_meeting_module_view?.pv) },
      { stepId: 'corporate_english_meeting_detail_view', label: '外企会议详情访问', uv: toInt(corporateEnglishMap.corporate_english_meeting_detail_view?.uv), pv: toInt(corporateEnglishMap.corporate_english_meeting_detail_view?.pv) },
      { stepId: 'corporate_english_meeting_video_play', label: '外企会议播放', uv: toInt(corporateEnglishMap.corporate_english_meeting_video_play?.uv), pv: toInt(corporateEnglishMap.corporate_english_meeting_video_play?.pv) },
