...
export default async function handler(req, res) {
  ...
  try {
    ...
    const corporateEnglishSectionViewCondition = (section) => `
      (
        event_name = 'corporate_english_section_view'
    ...
    const corporateEnglishFunnelQuery = `
      ...
      actor_steps AS (
        SELECT
          ...
          MIN(created_at) FILTER (WHERE ${corporateEnglishSectionViewCondition('ceo')}) AS corporate_english_ceo_visit_at,
          ...
          MIN(created_at) FILTER (WHERE ${corporateEnglishSectionViewCondition('english_interview')}) AS corporate_english_interview_visit_at,
          ...
          MIN(created_at) FILTER (WHERE ${corporateEnglishSectionViewCondition('foreign_meeting')}) AS corporate_english_meeting_visit_at,
      ...
      step_uv AS (
        ...
        UNION ALL
        SELECT 'corporate_english_ceo_visit' AS step_id, COUNT(*) AS uv
        FROM actor_steps
        WHERE corporate_english_ceo_visit_at IS NOT NULL
        UNION ALL
        SELECT 'corporate_english_ceo_video_play' AS step_id, COUNT(*) AS uv
        FROM actor_steps
        WHERE corporate_english_ceo_visit_at IS NOT NULL
          AND corporate_english_ceo_video_play_at IS NOT NULL
          AND corporate_english_ceo_video_play_at >= corporate_english_ceo_visit_at
        UNION ALL
        SELECT 'corporate_english_ceo_clip_play' AS step_id, COUNT(*) AS uv
        FROM actor_steps
        WHERE corporate_english_ceo_visit_at IS NOT NULL
          AND corporate_english_ceo_clip_play_at IS NOT NULL
          AND corporate_english_ceo_clip_play_at >= corporate_english_ceo_visit_at
        UNION ALL
        SELECT 'corporate_english_interview_visit' AS step_id, COUNT(*) AS uv
        FROM actor_steps
        WHERE corporate_english_interview_visit_at IS NOT NULL
        UNION ALL
        ...
        WHERE corporate_english_interview_visit_at IS NOT NULL
          ...
          AND corporate_english_interview_video_play_at >= corporate_english_interview_visit_at
        UNION ALL
        SELECT 'corporate_english_meeting_visit' AS step_id, COUNT(*) AS uv
        FROM actor_steps
        WHERE corporate_english_meeting_visit_at IS NOT NULL
        UNION ALL
        ...
        WHERE corporate_english_meeting_visit_at IS NOT NULL
          ...
          AND corporate_english_meeting_video_play_at >= corporate_english_meeting_visit_at
      ),
      step_pv AS (
        ...
        UNION ALL
        SELECT 'corporate_english_ceo_visit' AS step_id, COUNT(*) AS pv FROM base
        WHERE ${corporateEnglishSectionViewCondition('ceo')}
        UNION ALL
        ...
        UNION ALL
        SELECT 'corporate_english_interview_visit' AS step_id, COUNT(*) AS pv FROM base
        WHERE ${corporateEnglishSectionViewCondition('english_interview')}
        UNION ALL
        ...
        UNION ALL
        SELECT 'corporate_english_meeting_visit' AS step_id, COUNT(*) AS pv FROM base
        WHERE ${corporateEnglishSectionViewCondition('foreign_meeting')}
        UNION ALL
    ...
    const corporateEnglishFunnel = computeStepMetrics([
      ...
      { stepId: 'corporate_english_video_play', label: '视频播放/打开', uv: toInt(corporateEnglishMap.corporate_english_video_play?.uv), pv: toInt(corporateEnglishMap.corporate_english_video_play?.pv) },
      { stepId: 'corporate_english_clip_play', label: '跟读音频播放', uv: toInt(corporateEnglishMap.corporate_english_clip_play?.uv), pv: toInt(corporateEnglishMap.corporate_english_clip_play?.pv) },
      { stepId: 'corporate_english_ceo_visit', label: 'CEO访谈访问', uv: toInt(corporateEnglishMap.corporate_english_ceo_visit?.uv), pv: toInt(corporateEnglishMap.corporate_english_ceo_visit?.pv) },
      ...
      { stepId: 'corporate_english_interview_visit', label: '英语面试访问', uv: toInt(corporateEnglishMap.corporate_english_interview_visit?.uv), pv: toInt(corporateEnglishMap.corporate_english_interview_visit?.pv) },
      ...
      { stepId: 'corporate_english_meeting_visit', label: '外企会议访问', uv: toInt(corporateEnglishMap.corporate_english_meeting_visit?.uv), pv: toInt(corporateEnglishMap.corporate_english_meeting_visit?.pv) },
