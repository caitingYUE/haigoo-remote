// lib/api-handlers/rss-proxy-handler.js
...
export default async function rssProxyHandler(req, res) {
    if (req.method !== 'GET') {
    ...
    try {
        ...
        console.log(`[rss-proxy] Successfully fetched and cleaned RSS data from ${url}`);
