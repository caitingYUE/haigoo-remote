...
async function cleanFakeTranslations() {
  ...
  console.log('🧹 Pre-flight: Checking for fake translations...');
  try {
    ...
    if (toFix.length > 0) {
      console.log(`🧹 Found ${toFix.length} fake translations. Unmarking...`);
      ...
      console.log('✅ No fake translations found in this batch.');
    }
  } catch (e) {
...
export default async function handler(req, res) {
  console.log('[Cron:TranslateJobs] VERSION: FIX_REGEX_V2_DIRECT_CHARS_WITH_CLEANUP');
