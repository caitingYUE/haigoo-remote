...
const privacySections = [
  {
    title: '一、我们收集的信息',
    body: '为提供账号连接、岗位浏览、收藏、申请入口记录、Club 岗位订阅和权益购买服务，我们可能处理微信 OpenID、邮箱、账号信息、Club 权益状态、收藏与申请记录、订阅方向、搜索和岗位浏览记录，以及支付订单号、所购方案、金额和交易状态。我们不会保存您的银行卡号、支付密码，也不会在小程序中保存您的账号密码。'
  },
  {
    title: '二、信息使用目的',
    body: '上述信息仅用于身份识别、同步网站账号权益、提供岗位筛选和咨询配套功能、控制免费浏览额度、发送您主动订阅的邮件、处理支付与退款、发放 Club 权益、处理反馈、排查故障和防范滥用。未经授权，我们不会将信息用于与上述目的无关的用途。'
  },
  {
    title: '三、存储与第三方处理',
...
const termsSections = [
  ...
  {
    title: '三、岗位与外部申请',
    body: '小程序展示的信息来自企业官网或其他公开、可信来源，并可能经过筛选、翻译和整理。申请会在企业官网或邮箱中完成；打开或复制申请入口不代表已经完成申请，您应自行确认岗位真实性及外部网站规则。'
  },
  {
    title: '四、Club 权益与订阅',
