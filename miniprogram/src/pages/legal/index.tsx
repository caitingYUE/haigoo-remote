...
const privacySections = [
  {
    title: '一、我们收集的信息',
    body: '为提供账号连接、岗位浏览、收藏、申请入口记录和 Club 岗位订阅服务，我们可能处理微信 OpenID、邮箱、账号信息、Club 权益状态、收藏与申请记录、订阅方向、搜索和岗位浏览记录，以及保障服务安全所需的设备、网络和运行日志。我们不会在小程序中保存您的账号密码。'
  },
  {
    title: '二、信息使用目的',
...
const termsSections = [
  ...
  {
    title: '四、Club 权益与订阅',
    body: '首发版本仅展示 Club 权益方案并同步已有权益，不在小程序内完成付款。具体内容、期限和开通方式以双方确认的职业支持方案为准。'
  },
  {
    title: '五、合理使用',
