...
assert.ok(cloudrun.includes('...deliveredJobs, ...matchedJobs'), 'saved subscriptions must immediately return cached matching jobs')
...
assert.ok(membershipPage.includes('subscription-topic-search') && membershipPage.includes('maximumTopics'), 'member subscription topics must be searchable and show their limit')
