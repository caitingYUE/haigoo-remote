...
assert.match(miniPage, /const result = await fetchCareerWatch\(visitKey\.current\)\s+if \(scope !== miniContentScope\(\) \|\| sequence !== loadSequence\.current \|\| resumeFlowActive\.current\) return/)
