...
- 发布前应用小程序数据库迁移 `054`、`055`、`056`、`057`，记录执行时间和执行人。`058` 属于网站可信企业内推能力；当前小程序首发只支持官网和邮箱申请，不依赖该迁移。若测试库来自较早快照，还要核对网站基础迁移 `019`、`021`、`023`、`026`、`037`、`038`，否则 Club 岗位、企业和 Logo 数据以及小程序埋点可能静默走兼容回退。
